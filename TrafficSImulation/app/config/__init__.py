...
MINIMUM_SEGMENT_LENGTH_MILES = 0.1
SEGMENT_NAME_MAX_LENGTH = 80
...
HEATMAP_CENTER_LAT = MAP_DEFAULT_CENTER["lat"]
HEATMAP_CENTER_LNG = MAP_DEFAULT_CENTER["lng"]
HEATMAP_MAX_CENTER_DISTANCE_DEGREES = 0.32
HEATMAP_CONGESTION_BLEND = 0.62
HEATMAP_CENTER_BLEND = 0.23
HEATMAP_HOUR_BLEND = 0.15
HEATMAP_PEAK_HOUR_FACTOR = 1.0
HEATMAP_MID_HOUR_FACTOR = 0.72
HEATMAP_OFFPEAK_HOUR_FACTOR = 0.48
HEATMAP_FILL_OPACITY_MAX = 0.55
HEATMAP_METRIC = "congestion"
HEATMAP_NOTICE = (
    "Simulated congestion field for the selected departure hour. "
    "Planning estimate, not observed traffic."
)
